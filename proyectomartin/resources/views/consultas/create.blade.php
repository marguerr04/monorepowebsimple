...
@section('page-breadcrumb', 'Inicio / Consultas / Nueva')
            ...
            <form action="{{ route('consultas.store') }}" method="POST">
                ...
                <div class="mt-6">
                    ...
                    <textarea id="motivo_consulta" 
                              ...
                              class="w-full px-4 py-2 border-2 border-gray-300 rounded-lg focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all @error('motivo_consulta') border-red-500 @enderror">{{ old('motivo_consulta') }}</textarea>
